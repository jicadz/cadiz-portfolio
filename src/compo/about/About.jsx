    ...
    return(
        <section ref={ref} className="flex flex-col gap-[4rem] cursor-default my-[6rem]">
            ...
            <div className="flex flex-col gap-[2.5rem]">
                <p className="text-[2rem] tracking-tighter leading-10 lg:text-[4rem] lg:leading-[4.5rem]" data-aos="fade-up" data-aos-duration="800">I craft digital 
                experiences combining <strong>design, motion</strong> and <strong>development</strong>
                </p>

                <p className="text-[1.2rem] leading-7 font-mont" data-aos="fade-up" data-aos-duration="800">
