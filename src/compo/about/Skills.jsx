...
const Skills = () => {
    ...
    return(
        <div className="flex flex-col items-center gap-[1rem] lg:flex-row lg:text-left lg:items-start lg:gap-[3rem]">
            <h1 className="font-bgs text-[2.1rem] md:text-[3.5rem] lg:text-[3rem] lg:w-[220px]">Skills</h1>
            <div className="flex flex-col items-center gap-[1rem] mt-[2rem] lg:flex-row lg:items-start lg:gap-[3rem] lg:ml-[5rem]">
            <Lens children={
                <div className="skill-card flex flex-col items-center gap-[.7rem] font-mont p-[1rem] text-center">
                    ...
                    <ul className="text-[.8rem] text-[#878484]">
                        <li>Prototyping</li>
