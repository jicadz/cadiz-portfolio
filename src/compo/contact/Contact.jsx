    ...
    return(
        <section ref={ref} className="pb-[1rem] sm:mt-[15%] lg:pb-[2rem] lg:px-[5rem]">
            ...
            <div className="flex flex-col items-center border-[1px] border-[solid] border-[#393131] rounded-[50px] py-[7rem]" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <p className="font-mont font-medium text-[1.1rem] sm:text-[2.4rem] lg:text-[3.6rem] hover:text-[#E01515] cursor-pointer transition-all ease-in">joshuaiancadiz@gmail.com</p>
                <p className="font-mont font-medium text-[1.1rem] sm:text-[2rem] lg:text-[3rem] hover:text-[#E01515] cursor-pointer transition-all ease-in">(425) 555-1212</p>
            ...
            <div className="flex flex-col items-center mt-[1rem] md:flex-row md:justify-between overflow-hidden">
                <div className="font-mont relative w-[fit-content] leading-[1.3rem] text-[.7rem] md:text-[.9rem] md:order-2" data-aos="fade-up" data-aos-duration="800" data-aos-offset="0">
                    <p>Available for a full-time position</p>
                    <div className='pulse top-[5px]'>
                        <span style={{ "--i": 0 }}></span>
                    </div> 
                </div>
                <p className="font-mont text-[.7rem] text-[#878484] md:order-1" data-aos="fade-up" data-aos-duration="800" data-aos-offset="0">©2024 J.I. Cadiz</p>
                <p className="font-mont text-[.7rem] text-[#878484] md:order-3" data-aos="fade-up" data-aos-duration="800" data-aos-offset="0">Made by J.I. Cadiz</p>
            </div>
